  ...
  return (
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 animate-fade-in-up opacity-0" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
          <button 
            onClick={onBookOnline}
            className="group px-10 py-4 bg-brand-gold text-brand-black font-bold text-sm uppercase tracking-widest hover:bg-white transition-all duration-300 rounded-sm shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:shadow-[0_0_30px_rgba(212,175,55,0.6)] transform hover:-translate-y-1 flex items-center gap-2"
          >
          ...
          <div className="flex gap-4">
            <a 
              ...
              className="px-6 py-4 border border-white/20 text-white font-bold text-xs uppercase tracking-widest hover:bg-white/10 transition-all rounded-sm"
            >
              Table
            </a>
            <a 
              href={cleanPhoneLink(contactInfo.phone)}
              className="px-6 py-4 border border-brand-gold/30 backdrop-blur-sm text-brand-gold font-bold text-xs uppercase tracking-widest hover:border-brand-gold hover:bg-brand-gold hover:text-brand-black transition-all duration-300 rounded-sm shadow-lg flex items-center justify-center group"
            >
